...
# This layout will contain the following elements:
  ...
  intro_panel<-tabPanel(title = "Introduction",titlePanel("Income Inequality"),
...
# containing the following information:
main_content <-mainPanel(plotOutput(outputId = "plot"),
...
p("Data Frame",a("http://gabriel-zucman.eu/usdina/")))
...
# - Your `intro_panel`
# - Your `growth_panel`
ui <- navbarPage(title="Income Inequality",intro_panel)
